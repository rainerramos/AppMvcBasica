...
namespace AppMvcBasica.Controllers
{
    public class FornecedoresController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Nome,MyProperty,TipoFornecedor,Ativo,Id")] Fornecedor fornecedor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("Nome,MyProperty,TipoFornecedor,Ativo,Id")] Fornecedor fornecedor)
        {
            if (id != fornecedor.Id)
            {
                return NotFound();
